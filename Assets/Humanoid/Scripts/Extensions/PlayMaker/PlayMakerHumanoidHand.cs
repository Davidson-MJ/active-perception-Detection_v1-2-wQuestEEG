...
namespace Passer {
    ...
    /// <summary>Script for automatic sending of Grabbing and LettingGo events</summary>
...
namespace HutongGames.PlayMaker.Actions {
    ...
    /// <summary>Gets the hand pose</summary>
    ...
    /// <summary>Gets the object grabbed by the hand (if any)</summary>
    [ActionCategory("Humanoid Control")]
